                ...
                for (i = 0; i < len; i++) {
                  //The layerName is the name of the layer in the mxd that powers the service
                    if (contentArray[i].layerName === "Subdivision Plats") {
                        ...
                        att = contentArray[i].feature.attributes;
                        content += "<span title='Vacated ROW - Click to highlight' class='nored vac' id='i" + att.OBJECTID + "' onclick='getit(" + att.OBJECTID + ",19);' " + "></span> " + "<a target='_blank' href='https://recording.mesacounty.us/Landmarkweb//search/DocumentBy?ClerkFileNumber=" + att.RECEPTION + "'><b>" + att.ROAD + "</b> (Vacated ROW)</a><br>Book: " + att.BOOK + "<br>Page: " + att.PAGE + "<br>";
