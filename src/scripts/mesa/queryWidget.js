            ...
            return declare("queryWidget", [_WidgetBase, _TemplatedMixin], {
                    ...
                    postCreate: function () {
                        ...
                        on(dom.byId("qLayer"), "change", function () {
                            ...
                            if (selValue !== "none") {
                                attQueryTask = new QueryTask("https://mcgis.mesacounty.us/arcgis/rest/services/maps/" + selValue);
                                attQuery = new Query();
                    ...
                    _showSelected: function (results) {
                        ...
                        _showResults: function (result, incoming) {
                            ...
                            _runloqQuery: function (results, trig) {
                                ...
                                esriQuery = new Query();
                                loqQueryTask = new QueryTask("https://mcgis.mesacounty.us/arcgis/rest/services/maps/" + selValue);
                                esriQuery.returnGeometry = true;
                                esriQuery.outFields = ["*"];
