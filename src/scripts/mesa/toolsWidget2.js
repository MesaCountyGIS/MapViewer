/*
ToolsWidget creates and manages the left slide-out panel (including its state)
that houses the tool interfaces that are generated by the buttons in the top
header bar.
*/
...
define([
    ...
    return declare("toolsWidget2", [_WidgetBase, _TemplatedMixin], {
        ...
        postCreate: function () {
            ...
            //Set up event handlers for the header toolbar buttons and the left
            //slide out menu
            ...
            function togglePanel(e){
              /*Open and close the left tools panel*/
            ...
            function checkmarks(){
              /*Adds and removes the check marks next to the currently selected
              basemap/imagery year when the basemap tool is open*/
                return{
        ...
        dispatchThemeMenuClick: function(layer, components, flag) {
          /*This function controls what happens when a user clicks one of the
          map themes in the map theme dropdown #searchSelect*/
