define([
    ...
    "esri/tasks/PrintTask", "esri/tasks/PrintParameters", "esri/tasks/PrintTemplate", "esri/dijit/Print", "dojo/on", "dojo/touch",
     "dijit/_WidgetBase", "dijit/_TemplatedMixin", "dojo/text!./templates/toolsView.html", "mesa/measureWidget",
    "mesa/printWidget", "mesa/queryWidget", "mesa/bookmarkWidget", "mesa/helpWidget", "mesa/shareFormWidget", "dijit/registry", "mesa/basemapWidget", "dojo/domReady!"
    ...
    return declare("toolsWidget", [_WidgetBase, _TemplatedMixin], {
        ...
        postCreate: function () {
            ...
            on(dom.byId("MSearch"), "click", function(){
